...
public final class DaggerLauncherApplication_HiltComponents_SingletonC {
  ...
  private static final class ViewModelCImpl extends LauncherApplication_HiltComponents.ViewModelC {
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.naviViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 2);
      this.sidePanelViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 3);
    }

    @Override
    public Map<String, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return MapBuilder.<String, javax.inject.Provider<ViewModel>>newMapBuilder(4).put("com.bydlauncher.ui.apps.AppDrawerViewModel", ((Provider) appDrawerViewModelProvider)).put("com.bydlauncher.ui.home.HomeViewModel", ((Provider) homeViewModelProvider)).put("com.bydlauncher.ui.navi.NaviViewModel", ((Provider) naviViewModelProvider)).put("com.bydlauncher.ui.sidepanel.SidePanelViewModel", ((Provider) sidePanelViewModelProvider)).build();
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 1: // com.bydlauncher.ui.home.HomeViewModel 
          ...
          case 2: // com.bydlauncher.ui.navi.NaviViewModel 
          ...
          case 3: // com.bydlauncher.ui.sidepanel.SidePanelViewModel 
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 1: // com.bydlauncher.data.favorites.FavoritesRepositoryImpl 
          ...
          case 2: // com.bydlauncher.data.navi.NaviRepositoryImpl 
          ...
          case 3: // com.bydlauncher.data.weather.WeatherRepositoryImpl 
          ...
          case 5: // com.bydlauncher.data.calendar.CalendarRepositoryImpl 
